...
public class Start extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv[0] = findViewById(R.id.ivBlack1);
        iv[1] = findViewById(R.id.ivBlack2);
        iv[2] = findViewById(R.id.ivBlack3);
        iv[3] = findViewById(R.id.ivBlack4);
        iv[4] = findViewById(R.id.ivBlack5);
        iv[5] = findViewById(R.id.ivBlack6);
        iv[6] = findViewById(R.id.ivBlack7);
        iv[7] = findViewById(R.id.ivBlack8);

        // 게임이 시작되면, 초기화, 랜덤으로 블럭의 색상 지정
        for (int i = 0; i < iv.length; i++) {
            // 0, 1, 2 <- red, green, blue
            int num = new Random().nextInt(3); // 0, 1, 2 중의 랜덤 함수
    ...
    public void onClick(View v) {
        ...
        switch (imageView.getId()) {
            // 맨 아래 블럭 iv[7] ImageView 의 색상과 일치하는 버튼인지 판정
